...
public class BaseFPageAdapter extends FragmentPagerAdapter {
    ...
    public BaseFPageAdapter(FragmentManager fragmentManager, List<Fragment> list, List<String> titleList) {
    ...
    public BaseFPageAdapter(FragmentManager fragmentManager, List<Fragment> list, String[] strList) {
